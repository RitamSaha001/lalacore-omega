...
Future<void> main() async {
  ...
  const List<String> selectedChapters = <String>['Integrals'];
  ...
  final Map<String, dynamic> basePayload = <String, dynamic>{
    'title': 'AI Practice Quiz • Integrals (PYQ)',
    ...
    'pyq_mode': aiPreferPyq ? 'strict_related_web' : 'hybrid',
    'pyq_web_only_mode': aiPreferPyq,
    'pyq_answer_retrieval_required': aiPreferPyq,
  ...
  print('');
  print(
    '========== STUDENT AI GENERATION REPORT (INTEGRALS • PYQ MODE) ==========',
  );
  print('run_time: ${DateTime.now().toIso8601String()}');
  print('requested_chapter: Integrals');
